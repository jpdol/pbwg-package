...
<div align="center">
  <img src="https://github.com/jpdol/pbwg-package/blob/main/KPI01/kpi01_diagram.png?raw=true" alt="KPI01 Diagram" width="80%">
</div>
...
| delay        | Delay in minutes (positive or negative)             | 3                       |
| v1a          | On time according to Variant 1A                     | 0 or 1                  |
| v1b          | On time according to Variant 1B                     | 0 or 1                  |
| v2a          | On time according to Variant 2A                     | 0 or 1                  |
| v2b          | On time according to Variant 2B                     | 0 or 1                  |
| kpi01_v1a    | Percentage of on-time flights for Variant 1A        | 0.80                    |
| kpi01_v1b    | Percentage of on-time flights for Variant 1B        | 0.50                    |
| kpi01_v2a    | Percentage of on-time flights for Variant 2A        | 1.0                     |
| kpi01_v2b    | Percentage of on-time flights for Variant 2B        | 0.0                     |
